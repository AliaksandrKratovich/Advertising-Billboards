...
namespace Server
{
    public class ServerEmulation : IServerEmulation
    {
        ...
        public ServerEmulation(IAdvertisingService advertisingService, IDeviceService deviceService, IAdvertisementStatisticsService advertisementStatisticsService)
        {
        ...
        public void ChangeFrequencyForDevice(long deviceId, int frequency)
        {
            ...
            for (int i = 0; i < frequency; i++)
            {
                ...
                {
                    queueAdvert.Enqueue(advertisement);
                    _advertisementStatisticsService.AddAdvertisingStatistics(advertisement.Id, $"the video was added in queue for device {deviceId}");
                }
            }
