...
using Advertising_Billboards.ModelsView;
...
namespace Advertising_Billboards.Controllers
{
    public class UserController : Controller
    {
        ...
        public IActionResult SubmitFrequency(long deviceId, long deviceGroupId, int frequency)
        {
            ...
            if (deviceId != 0)
            {
                ...
                _server.ChangeFrequencyForDevice(deviceId, frequency);
            ...
            using (StreamReader reader = new StreamReader(fileName))
            {
                ...
                if (int.TryParse(reader.ReadToEnd(), out var frequency))
                {
                    ...
                    else if (deviceGroupId != 0)
                    {
                        ...
                        _server.ChangeFrequencyForDevice(deviceGroupId, frequency);
                        return RedirectToAction("DeviceGroups");
                    }
                }
            }
